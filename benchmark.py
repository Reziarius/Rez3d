...
def run_single_benchmark():
    user_input = input("\nInserisci il numero di ordini dummy da simulare [Default 100]: ").strip()
    count = 100
    ...
    fig.suptitle(f'JPA Fetching Strategies Benchmark (Ordini Simulati: {count})', fontsize=16, fontweight='bold')
...
def run_curve_benchmark():
    ...
    fig.suptitle('Curva di Scalabilità JPA: Tempo di Esecuzione e Query SQL in funzione di N', fontsize=15, fontweight='bold')
    ...
    ax1.set_title('Andamento del Tempo di Esecuzione (ms) vs N Ordini', fontsize=12, fontweight='bold')
    ax1.set_xlabel('Numero di Ordini Simulati (N)', fontsize=11)
...
def main():
    print("=================================================================")
    print("   REZ3D - JPA/HIBERNATE FETCH STRATEGIES BENCHMARK (Python)     ")
    print("=================================================================")
